...
ссылка (https://lagutanv2.github.io/js-3_HW_03-events/)
CI [![Build status](https://ci.appveyor.com/api/projects/status/yhh4mj4npdr0cl3b?svg=true)](https://ci.appveyor.com/project/LagutaNV2/js-3-hw-03-events)
...
#### Описание
ссылка на результат выполнения Д.з. к занятию "2. DOM":
